...
#import "LBTabBarControllerConfig.h"
...
@interface LBTabBarControllerConfig ()

@property (nonatomic, readwrite, strong) LBTabBarController *tabBarController;

@end


@implementation LBTabBarControllerConfig


/**
 *  lazyload tabBarController
 *
 *  @return LBTabBarController
 */
 ...
 *
 */
- (void)setUpTabBarItemsAttributesForController:(LBTabBarController *)tabBarController {
    ...
    NSDictionary *dict3 = @{
                            LBTabBarItemTitle : @"消息",
                            LBTabBarItemImage : @"message_normal",
                            LBTabBarItemSelectedImage : @"message_highlight",
                            };
    NSDictionary *dict4 = @{
                            LBTabBarItemTitle : @"我的",
                            LBTabBarItemImage : @"account_normal",
                            LBTabBarItemSelectedImage : @"account_highlight"
                            };
